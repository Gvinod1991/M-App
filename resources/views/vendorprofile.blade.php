        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                     <a href="javascript:void(0);" class="btn btn-sm btn-primary" title="">Seetings</a>
                    <a href="javascript:void(0);" class="btn btn-sm btn-primary" title="">Availability</a>
                    <a href="javascript:void(0);" class="btn btn-sm btn-primary" title="">Booking Details</a>
                </div>
            </div>
        </div>
        <div class="container-fluid">           
			<div class="row clearfix">
                ...
                @foreach($data["vendors"] as $vendor)
                  <?php $sts = $vendor->sts;$vid =$vendor->id; ?>
                @endforeach
                    <h5>Status : 
                    @if($sts =='Active') 
                    ...
                    <div class="card pricing2">
                        <div class="body">
                            <div class="pricing-plan">
                                <img src="./images/user.png" alt="" class="pricing-img">
                                <h2 class="pricing-header">{{$vendor->shop_name}}</h2>
									
                               
                                <a href="javascript:void(0);" class="btn btn-outline-primary">Change Profile Pic</a>
                              </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-md-12">
                     ...
                     <div class="body">
                            ...
                            <p><i class="fa fa-instagram m-r-5"></i> {{$vendor->instagram_link}}</p>
                             @endforeach
							<hr>
							<a href="javascript:void(0);" class="btn btn-outline-primary">Change Vendor Info</a>
							<hr>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td class="actions">
                                                ...
                                                <button class="ser-dis btn btn-sm btn-icon btn-pure btn-default on-default button-remove" data-id="{{$vendor->id}}" data-status="{{$vendor->is_enable}}" data-toggle="modal" data-target="#yesno"
                                    ...
                                    @foreach($data["timeslot"] as $vendor)
                                        <tr>
											...
											<td class="actions">
                                                 ...
                                                 <button class="time-dis btn btn-sm btn-icon btn-pure btn-default on-default button-remove" data-id="{{$vendor->id}}" data-status="{{$vendor->is_enable}}" data-toggle="modal" data-target="#all_block"
                                                data-toggle="tooltip" data-original-title="Disable"><i class="icon-lock" aria-hidden="true"></i></a>
					 ...
					 <div class="card single_post2">
                                ...
                                <div class="body">                    
                                    <div class="content">
                                         ...
                                         <a class="btn btn-primary" href="javascript:void(0)">Change Image</a>
                                    </div>
                                </div>
                            </div>
				</div>
         ...
         jQuery(document).ready(function(){
            ...
            jQuery('#EditServices').click(function(e){
               ...
               jQuery.ajax({
                  ...
                  data: 
                  {
                     service: jQuery('#service_edit').val(),
                     price: jQuery('#price_edit').val(),
                     offer: jQuery('#offer_edit').val(),
                     vid: jQuery('#sid').val()
                  },
                  success: function(result)
                  {
